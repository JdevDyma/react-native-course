...
Sur Android connecté par ADB, `adb reverse tcp:9090 tcp:9090` permet à l'application de joindre Reactotron sur la machine hôte. Avec un appareil physique sur le réseau, indiquez l'adresse de la machine dans l'option `host` de `configure`.
