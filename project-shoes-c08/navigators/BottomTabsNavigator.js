  ...
  return (
    <Tabs.Navigator initialRouteName="HomeStack"
      ...
      <Tabs.Screen name="Cart" component={Cart}
        options={{ title: "Panier", tabBarAccessibilityLabel: "Panier",
          tabBarIcon: ({ color, focused }) => (
            <View style={[styles.cartContainer, focused ? styles.activeCart : styles.inactiveCart]}>
              <CartIcon width={focused ? FOCUSED_ICON_SIZE : SMALL_ICON_SIZE} height={focused ? FOCUSED_ICON_SIZE : SMALL_ICON_SIZE}
                color={focused ? colors.WHITE : color} accessible={false} />
            </View>
          ),
        }} />
