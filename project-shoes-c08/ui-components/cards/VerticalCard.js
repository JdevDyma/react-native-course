...
export default function VerticalCard({ item, onPress, listScreen = false }) {
    ...
    <View style={[styles.container, { width: cardWidth }]}>
      <View style={styles.clip}>
        <Touchable style={styles.touchableContainer} onPress={onPress}
          accessibilityLabel={`${item.name}, ${item.price} euros${listScreen ? `, couleurs : ${availableColors.join(", ")}` : ""}`}>
