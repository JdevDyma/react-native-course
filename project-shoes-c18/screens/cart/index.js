      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={{ flex: 1 / numColumns }}><ListItem item={item} removeShoesFromCart={removeShoesFromCart}
            updateQuantity={updateQuantity} busy={!profile.canWrite || paymentBusy} /></View>
        )}
        ...
        ListFooterComponent={profile.user ? <PriceSummary totalAmount={totalAmount} profile={profile} onBusyChange={setPaymentBusy} /> : null}
