    ...
    <Stack.Navigator screenOptions={{
      ...
      <Stack.Group screenOptions={({ navigation }) => ({
        ...
        <Stack.Screen name="MainCart" component={Cart}
          options={{ title: "Mon panier", animation: "slide_from_bottom" }} />
        <Stack.Group screenOptions={{ contentStyle: {
          paddingBottom: insets.bottom, backgroundColor: colors.LIGHT,
        } }}>
          <Stack.Screen name="List" component={List} options={{ title: "Chaussures" }} />
          <Stack.Screen name="NewsList" component={NewsList} options={{ title: "Nouveautés" }} />
        </Stack.Group>
      </Stack.Group>
      </Stack.Group>}
    </Stack.Navigator>
